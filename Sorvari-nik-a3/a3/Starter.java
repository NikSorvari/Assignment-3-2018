...
{	private GLCanvas myCanvas;
	...
	private int earthTex;
	private Texture joglEarthTex;
	...
	double cameraRotateX = 0.0;
	double cameraRotateY = 0.0;
	
	KeyFwd kFwd = new KeyFwd();
	private class KeyFwd extends AbstractAction
	{
		@Override
	...
	KeyBwd kBwd = new KeyBwd();
	private class KeyBwd extends AbstractAction
	{
		@Override
		public void actionPerformed(ActionEvent arg0) {
	...
	KeyRs kRs = new KeyRs();
	private class KeyRs extends AbstractAction
	{
		@Override
		public void actionPerformed(ActionEvent arg0) {
	...
	KeyLs kLs = new KeyLs();
	private class KeyLs extends AbstractAction
	{
		@Override
		public void actionPerformed(ActionEvent arg0) {
	...
	KeyUs kUs = new KeyUs();
	private class KeyUs extends AbstractAction
	{
		@Override
		public void actionPerformed(ActionEvent arg0) {
	...
	KeyDs kDs = new KeyDs();
	private class KeyDs extends AbstractAction
	{
		@Override
		public void actionPerformed(ActionEvent arg0) {
	...
	KeyRr kRr = new KeyRr();
	private class KeyRr extends AbstractAction
	{
		@Override
		public void actionPerformed(ActionEvent arg0) {
	...
	KeyLr kLr = new KeyLr();
	private class KeyLr extends AbstractAction
	{
		@Override
		public void actionPerformed(ActionEvent arg0) {
	...
	KeyUr kUr = new KeyUr();
	private class KeyUr extends AbstractAction
	{
		@Override
		public void actionPerformed(ActionEvent arg0) {
	...
	KeyDr kDr = new KeyDr();
	private class KeyDr extends AbstractAction
	{
		@Override
		public void actionPerformed(ActionEvent arg0) {
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		joglEarthTex = loadTexture("earth.jpg");
		earthTex = joglEarthTex.getTextureObject();
